...
adapters._date.override(typeof moment_default === "function" ? {
  ...
  parse: function(value, format2) {
    if (typeof value === "string" && typeof format2 === "string") {
      value = moment_default(value, format2);
  ...
  format: function(time, format2) {
    return moment_default(time).format(format2);
  },
  add: function(time, amount, unit) {
    return moment_default(time).add(amount, unit).valueOf();
  },
  diff: function(max2, min2, unit) {
    return moment_default(max2).diff(moment_default(min2), unit);
  },
