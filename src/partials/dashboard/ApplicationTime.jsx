...
function ApplicationTime() {
  ...
  return (
    <div className="col-span-12 xl:col-span-8 bg-white  rounded-sm border border-slate-200 dark:border-slate-700">
      <div className="px-5 pt-5">
        <h2 className="text-lg font-semibold text-black bg-white mb-2">
          Application Time
        </h2>
        ...
        <div className="flex items-start">
          <div className="text-3xl font-bold text-black bg-white mr-2">
            Accumulate: 82
          </div>
